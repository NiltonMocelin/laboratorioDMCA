...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        if in_port == 1:
            ...
            addRegraF(datapath, ip_src, ip_dst, in_port, out_port, proto, 1, None)
            ...
            addRegraF(datapath, ip_src, ip_dst, in_port, out_port, 17, 100, 20)
        ...
        if in_port == ofproto.OFPP_LOCAL:
            ...
            addRegraF(datapath, ip_src, ip_dst, in_port, out_port, 17, 100, 10)        
